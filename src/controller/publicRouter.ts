...
import { getAllRooms, getRoomById, getRoomByIntervalAndLocation, getRoomByOptions } from "../services/room/getRoom";
...
publicRouter.get("/find/room/options",getRoomByOptions);
